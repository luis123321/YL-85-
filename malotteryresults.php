                ...
                <div class="crumbs">
                    <div class="container">
                        <ul>
                            ...
                            <li>/</li>
                            <li>Massachusetts Lottery Results</li>                                       
                        </ul>
                    </div>        
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="lt-loterry">
                            <div class="panel-box">
                                ...
                                <div class="titles available">
                                    <h4><i class="fa fa-circle-o-notch"></i>Mega Millons</h4>                                 
                                </div>
                        ...
                        <div class="lt-loterry">
                            <div class="panel-box">
                                ...
                                <div class="titles available">
                                     <h4><i class="fa fa-circle-o-notch"></i>Powers Ball</h4>                                 
                                </div>
                                <div class="container-lt">
                                <div class="content-balls">
                                    <ul class="balls-ul">
                        ...
                        <div class="lt-loterry">
                            <div class="panel-box">
                                <div class="ltn-img">
                                    <img src="img/loterry/ma/ma-numbersgame.jpg" alt="MA Numbers">
                                </div>
                                <div class="titles available">
                                    <h4><i class="fa fa-circle-o-notch"></i>Numbers</h4>                                
                                </div>
                                <div class="container-lt">
                                <div class="content-balls">
                                    <ul class="balls-ul">
                        ...
                        <div class="lt-loterry">
                            <div class="panel-box">
                                ...
                                <div class="titles available">
                                   <h4><i class="fa fa-circle-o-notch"></i>Mass Cash</h4>                                  
                                </div>
                                <div class="container-lt">
                                <div class="content-balls">
                                    <ul class="balls-ul">
                        ...
                        <div class="lt-loterry">
                            <div class="panel-box">
                                ...
                                <div class="titles available">
                                    <h4><i class="fa fa-circle-o-notch"></i>Lucky 4 life</h4>                                
                                </div>
                                <div class="container-lt">
                                <div class="content-balls">
                                    <ul class="balls-ul">
                        ...
                        <div class="lt-loterry">
                            <div class="panel-box">
                                ...
                                <div class="titles available">
                                    <h4><i class="fa fa-circle-o-notch"></i>Megabucks</h4>                                     
                                </div>
                                <div class="container-lt">
                                <div class="content-balls">
                                    <ul class="balls-ul">
