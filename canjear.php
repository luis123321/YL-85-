                ...
                <div class="container">
                    <div class="col-md-12">
                            ...
                            <div class="panel-box">
                                ...
                                <div class="titles">
                                    <h4 style="text-align: center;">Digite su codigo aqui:</h4>                                 
                                </div>
                                <div class="container">
                                <div class="row">
                                        <div class="col-md-5 col-md-offset-3">
                                            <input type="text" name="" value="" class="form-control txtchange" placeholder="">
                                            
                                        </div>
                                        <div class="col-md-5 col-md-offset-3 text-center">
                                        <input type="button" name="" value="Canjear" class="btn btnchange">
                                            <br>
                                        </div>
                                </div>
                                </div>
