                ...
                <div class="crumbs">
                    <div class="container">
                        <ul>
                            ...
                            <li>/</li>
                            <li>New York Lottery Results</li>                                       
                        </ul>
                    </div>        
                </div>
                        ...
                        <div class="lt-loterry">
                            <div class="panel-box">
                                ...
                                <div class="container-lt">
                                    <div class="row">
                               <div class="col-md-3">
                                   <p style="text-align: center;"><b>Dia</b></p>
                                       <div class="content-balls">
                                    <ul class="balls-ul">
                                        <li>19</li>
                                        <li>20</li>
                                    ...
                                    <p style="text-align: center;">Proximo Sorteo : 00:00:00</p>
                                        </div>
                                   </div>
                                    <div class="col-md-3">
                                   <p style="text-align: center;"><b>Noche</b></p>
                                       <div class="content-balls">
                                    <ul class="balls-ul">
                                        <li>19</li>
                                        <li>20</li>
